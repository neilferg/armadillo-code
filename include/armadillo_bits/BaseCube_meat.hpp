...
inline
void
BaseCube<elem_type,derived>::snip_print(const std::string extra_text) const
  {
  arma_extra_debug_sigprint();
...
inline
void
BaseCube<elem_type,derived>::snip_print(std::ostream& user_stream, const std::string extra_text) const
  {
  arma_extra_debug_sigprint();
...
arma_warn_unused
elem_type
BaseCube<elem_type,derived>::sum() const
  {
